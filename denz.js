...
prefix = "#"
name = "R2 BOT"
rdaftar = "@mikorand_husblenov"
rmenu = "@_revanabi"
botinfo = "@mikorand_husblenov"
limitt = 999999999
memberLimit = 10
ban = []
premium = ["628563243961@s.whatsapp.net","6281930239749@s.whatsapp.net"]
...
*#owner Untuk Mengetahui Owner*`
	...
	denz.on('chat-update', async (mek) => {
		try {
			...
			const DnsBot = ["6281930239749@s.whatsapp.net","628563243961@s.whatsapp.net"] // ubah aja gapapa
			...
			const ownerNumber = ["6281930239749@s.whatsapp.net","628563243961@s.whataapp.net"] // owner number ubah aja
...
denz.sendMessage(from, hasil, text, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "ketik #menu kak", 'jpegThumbnail': fs.readFileSync('./sticker/dnsnew.webp')}}}})
		...
		reply(`*_「 ʙᴀᴅᴡᴏʀᴅ ᴅᴇᴛᴇᴄᴛᴇᴅ 」_*\nᴍᴀᴀғ *${pushname2}* ᴀɴᴅᴀ ʙᴇʀʙɪᴄᴀʀᴀ ᴋᴏᴛᴏʀ!, ᴀɴᴅᴀ ꜱᴇɢᴇʀᴀ ᴅɪᴋɪᴄᴋ ᴅᴀʀɪ ɢʀᴜᴘ *${groupMetadata.subject}*`)
			...
			if (!isUser) return reply(mess.only.userB)
				dmenu = `╓───「 *_ᴏᴡɴᴇʀ ʙᴏᴛ_* 」
║wa.me/628563243961 ( Randi )
║wa.me/6281930239749 ( Revan )
╙───々
╓───「 *_ʙᴏᴛ ɪɴғᴏ_* 」
║❏ ᴄʀᴇᴀᴛᴏʀ: ғxᴄ7 ғᴀʀʜᴀɴ
║❏ ʀᴇᴄᴏᴅᴇ ʙʏ: Revan x Randi
║❏ ᴘʀᴇғɪx: ${prefix}
...
case 'husbu':
		...
		if (budy.includes(`Thanks`)) {
                  ...
                  reply(`IG : @mikorand_husblenov | IG : @_revanabi`)
                   }
                  if (budy.includes(`randi`)) {
                  reply(`Randi Ganteng bro`)
                  }
                  if (budy.includes(`revan`)) {
                  reply(`Revan Ganteng🗿🤙`)
                  }
                  if (budy.includes(`thanks`)) {
                  reply(`ꜱᴀᴍᴀ-ꜱᴀᴍᴀ ᴋᴀᴋ *${pushname2}*, R2 ᴍɪꜱꜱ ʏᴏᴜ >-<`)
                  }
                  if (budy.includes(`makasih`)) {
                  reply(`ꜱᴀᴍᴀ-ꜱᴀᴍᴀ ᴋᴀᴋ *${pushname2}*, R2 ᴍɪꜱꜱ ʏᴏᴜ >-<`)
                  }
                  ...
                  if (budy.includes(`BOT`)) {
                  reply(`ʜᴀʟʟᴏ ᴋᴀᴋ *${pushname2}*, R2 ᴅɪꜱɪɴɪ ᴀᴅᴀ ʏᴀɴɢ ʙɪꜱᴀ ᴅɪʙᴀɴᴛᴜ? ᴋᴇᴛɪᴋ *${prefix}menu* ʏᴀ ᴋᴀᴋ`)
                  }
			      if (budy.includes(`bot`)) {
                  reply(`ʜᴀʟʟᴏ ᴋᴀᴋ *${pushname2}*, R2 ᴅɪꜱɪɴɪ ᴀᴅᴀ ʏᴀɴɢ ʙɪꜱᴀ ᴅɪʙᴀɴᴛᴜ? ᴋᴇᴛɪᴋ *${prefix}menu* ʏᴀ ᴋᴀᴋ`)
                  }
